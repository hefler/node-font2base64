...
import { encodeToDataSrcSync, encodeToDataSrc, injectBase64Sync, injectBase64 } from './index.js';
...
describe('Replace font src with base64 data src without resave', function () {
  it(`should replace src`, function (done) {
    ...
    equal(results[0].modified, true);
    equal(results[0].content, expected);
    done();
  });
